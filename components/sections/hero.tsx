...
function HeroTitles() {
   return (
      <div className="flex w-full max-w-2xl flex-col space-y-4 overflow-hidden pt-8">
         ...
         >
            MultiModal Gpt is a powerful AI tool that can do multiple tasks at once. It can generate text, images, and even code. It can also be used for data analysis, data visualization, and more.
         </motion.p>
      </div>
   )
}
